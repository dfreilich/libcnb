...
// Build represents the contents of build.toml.
...
type BOMEntry struct {
	...
	// will be added to the Bill of Materials. Launch should be true if the entry describes the contents
	// of a launch layer or the app dir.
	Launch bool
